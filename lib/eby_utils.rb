module EbyUtils
  ...
  # constants
  BIBLE_BOOKS = { 'בראשית' => 1, 'שמות' => 2, 'ויקרא' => 3, 'במדבר' => 4, 'דברים' => 5, 'יהושע' => 6, 'שופטים' => 7, "שמואל א'" => 8, "שמואל ב'" => 9, "מלכים א'" => 10, "מלכים ב'" => 11, 'ישעיהו' => 12, 'ירמיהו' => 13, 'יחזקאל' => 14, 'הושע' => 15, 'יואל' => 16, 'עמוס' => 17, 'עובדיה' => 18, 'יונה' => 19, 'מיכה' => 20, 'נחום' => 21, 'חבקוק' => 22, 'צפניה' => 23, 'חגי' => 24, 'זכריה' => 25, 'מלאכי' => 26, 'תהילים' => 27, 'משלי' => 28, 'איוב' => 29, 'שיר השירים' => 30, 'רות' => 31, 'איכה' => 32, 'קהלת' => 33, 'אסתר' => 34, 'דניאל' => 35, 'עזרא' => 36, 'נחמיה' => 37, "דברי הימים א'" => 38, "דברי הימים ב'" => 39,"בראש'" => 1,"שמ'" => 2, "ויק'" => 3, "במד'" => 4, "דבר'" => 5, "יהו'" => 6,"שופ'" => 7, "ש\"א" => 8, "ש\"ב" => 9, "שמ\"א" => 8, "שמ\"ב" => 9, "מ\"א" => 10, "מ\"ב" => 11, "מל\"א" => 10, "מל\"ב" => 11, "יש'" => 12, "יר'" => 13, "יח'" => 14, "הוש'" => 15, "יו'" => 16, "עמ'" => 17, "עו'" => 18, "יונ'" => 19, "מי'" => 20, "נח'" => 21, "חב'" => 22, "צפ'" => 23, "חגי" => 24, "זכ'" => 25, "מלא'" => 26, "תה'" => 27, "משל'" => 28, "איוב" => 29, "שה\"ש" => 30, "רות" => 31, "איכ'" => 32, "קהל'" => 33, "אס'" => 34, "דנ'" => 35, "עז'" => 36, "נח'" => 37, "דה\"א" => 38, "דה\"ב" => 39}
  BIBLE_LINKS = { 
  ...
  def bible_link(s)
    ...
    puts parts
    debugger
    link = BIBLE_LINKS[BIBLE_BOOKS[parts[0]] - 1]
