...
ActiveRecord::Schema.define(version: 2020_10_20_234703) do
  ...
  create_table "eby_aliases", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "eby_column_images", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
  ...
  create_table "eby_def_events", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    t.integer "who"
    t.integer "thedef"
    t.string "old_status"
    t.string "new_status"
  ...
  create_table "eby_def_part_images", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    t.integer "thedef"
    t.integer "partnum"
  ...
  create_table "eby_defs", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    t.string "defhead"
  ...
  create_table "eby_markers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    t.integer "user_id"
    t.integer "def_id"
    t.integer "partnum"
    t.integer "marker_y"
  ...
  create_table "eby_scan_images", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    t.string "origjpeg"
    t.string "smalljpeg"
    t.integer "volume"
  ...
  create_table "eby_users", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    t.string "login"
    t.string "password"
    t.string "fullname"
    t.string "email"
