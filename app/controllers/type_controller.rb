class TypeController < ApplicationController
  ...
  def populate(d)
    ...
    d.footnotes = '' if d.footnotes =~ I18N.t(:type_footnotes) # remove the placeholder text that TinyMCE causes us to stick in the textarea # TODO: upgrade to TinyMCE 4.x and use proper HTML5 placeholders to avoid this kluge
